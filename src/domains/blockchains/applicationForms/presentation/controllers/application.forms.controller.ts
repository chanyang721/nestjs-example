...
import {
  contractAuditMulterOptions,
  dappIconMulterOptions,
  multerOptions,
} from '@/libs/helpers/multer/options';
  ...
  implements ApplicationFormControllerAdaptor
{
  ...
  async registerApplicationForm(
    ...
    const newApplicationForm =
      await this.applicationFormsService.registerApplicationForm(
        files,
        registerApplicationFormDto,
      );
  ...
  async registerDappApplicationForm(
    ...
    const newApplicationFormDapp: ApplicationFormDappDto =
      await this.applicationFormsService.registerApplicationFormDapp(
        file,
        registerApplicationFormDapp,
      );
