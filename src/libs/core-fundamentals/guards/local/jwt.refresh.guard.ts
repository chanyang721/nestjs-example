...
import { COOKIE_ACCESS_TOKEN_NAME, COOKIE_REFRESH_TOKEN_NAME, COOKIE_REFRESH_TOKEN_OPTIONS } from "../../../utils/constants";
  ...
  async canActivate( context: ExecutionContext ): Promise<boolean> {
    ...
    try {
      ...
      if ( !expiredToken ) {
        ...
        if ( expiredToken ) {
          response.clearCookie(COOKIE_ACCESS_TOKEN_NAME, COOKIE_REFRESH_TOKEN_OPTIONS);
